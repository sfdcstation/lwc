...
import methodFirst from '@salesforce/apex/promiseExample1.methodFirst';
import methodSecond from '@salesforce/apex/promiseExample1.methodSecond';
import methodThird from '@salesforce/apex/promiseExample1.methodThird';

export default class PromiseExample1 extends LightningElement 
{
    anyOrder() {
        console.log('\n\n Any Order');
        methodFirst()
